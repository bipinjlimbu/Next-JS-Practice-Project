            ...
            <div className="w-full max-w-md p-6 md:p-8 bg-slate-900/40 border border-slate-800 rounded-2xl relative z-10 space-y-6">
                ...
                <div className="text-center space-y-2">
                    ...
                    <p className="text-slate-400 text-xs">
                        Join us to manage your workspace and explore our items
                    </p>
                </div>
                ...
                <form className="space-y-4">
                    ...
                    <div className="flex items-start">
                        <input
                            ...
                            id="terms"
                            required
                            className="w-4 h-4 mt-0.5 rounded bg-slate-950 border-slate-800 text-indigo-500 focus:ring-0 focus:ring-offset-0 cursor-pointer accent-indigo-500"
                        />
                        <label htmlFor="terms" className="ml-2 text-xs text-slate-400 select-none cursor-pointer leading-normal">
                            I agree to the{' '}
                ...
                <div className="relative flex py-2 items-center">
                    ...
                    <span className="flex-shrink mx-3 text-[10px] uppercase font-bold tracking-wider text-slate-500">Or sign up with</span>
                    <div className="flex-grow border-t border-slate-800"></div>
                </div>
